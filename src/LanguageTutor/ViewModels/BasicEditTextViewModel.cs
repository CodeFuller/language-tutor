...
namespace LanguageTutor.ViewModels
{
	public abstract class BasicEditTextViewModel : ObservableObject, IBasicEditTextViewModel
	{
		...
		protected ITutorService TutorService { get; }

		protected IDictionaryService DictionaryService { get; }
		...
		protected BasicEditTextViewModel(ITutorService tutorService, IDictionaryService dictionaryService, ISpellCheckService spellCheckService,
		...
		{
			TutorService = tutorService ?? throw new ArgumentNullException(nameof(tutorService));
			DictionaryService = dictionaryService ?? throw new ArgumentNullException(nameof(dictionaryService));
		...
		protected async Task LoadData(Language language, bool requireSpellCheck, bool createPronunciationRecord, CancellationToken cancellationToken)
		{
			...
			var existingLanguageTexts = await DictionaryService.GetLanguageTexts(language, cancellationToken);
