...
{
	internal sealed class SwitchToPracticeLanguagePageEventArgs : EventArgs
	{
		public Language StudiedLanguage { get; }

		public Language KnownLanguage { get; }

		public SwitchToPracticeLanguagePageEventArgs(Language studiedLanguage, Language knownLanguage)
		{
