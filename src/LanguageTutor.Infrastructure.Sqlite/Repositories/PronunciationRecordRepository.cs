...
namespace LanguageTutor.Infrastructure.Sqlite.Repositories
{
	internal sealed class PronunciationRecordRepository : IPronunciationRecordRepository
	{
		...
		private readonly LanguageTutorDatabaseSettings settings;

		public PronunciationRecordRepository(IDbContextFactory<LanguageTutorDbContext> contextFactory, IChecksumCalculator checksumCalculator, IOptions<LanguageTutorDatabaseSettings> options)
		{
