...
{
	[TestClass]
	public class TranslateTextExerciseExtensionsTests
	{
		[TestMethod]
		...
		[TestMethod]
		public void GetHintForOtherSynonyms_ForTextWithoutSynonyms_ReturnsEmptyString()
		{
			// Arrange
		...
		[TestMethod]
		public void GetHintForOtherSynonyms_ForTextWithSynonymsWithoutMatchingWords_ReturnsCommaSeparatedListOfSynonyms()
		{
			// Arrange
		...
		[TestMethod]
		public void GetHintForOtherSynonyms_ForTextWithSynonymsWithMatchingWords_MasksMatchingWords()
		{
			// Arrange
