...
{
	[TestClass]
	public class EditVocabularyViewModelTests
	{
		private sealed class TestTargetDependencies
		{
			public Mock<IEditVocabularyService> EditVocabularyServiceMock { get; } = new();
			...
			{
				EditVocabularyServiceMock.Invocations.Clear();
		...
		public void Constructor_IfSameInstanceIsPassedForCreateOrPickTextViewModels_Throws()
		{
			...
			var call = () => new EditVocabularyViewModel(Mock.Of<IEditVocabularyService>(), Mock.Of<IMessenger>(),
		...
		public async Task Load_ForFirstCall_InitializesViewModelCorrectly()
		{
			...
			var expectedViewModelData = new EditVocabularyViewModelData
			{
			...
			target.Should().BeEquivalentTo(expectedViewModelData, EditVocabularyViewModelData.ExcludingCommands);
		...
		public async Task SaveChangesCommand_ForNewTranslationModeIfViewModelForTextInStudiedLanguageHasValidationErrors_ReturnsWithoutSavingChanges()
		{
			...
			dependencies.EditVocabularyServiceMock.Verify(x => x.AddTranslation(It.IsAny<LanguageText>(), It.IsAny<LanguageText>(), It.IsAny<CancellationToken>()), Times.Never);
		}
		...
		public async Task SaveChangesCommand_ForNewTranslationModeWithNoValidationErrors_SavesChangesCorrectly()
		{
			...
			dependencies.EditVocabularyServiceMock.Setup(x => x.AddTranslation(newTextInStudiedLanguage, newTextInKnownLanguage, It.IsAny<CancellationToken>())).ReturnsAsync(newTranslation);
			...
			dependencies.EditVocabularyServiceMock.Verify(x => x.AddTranslation(newTextInStudiedLanguage, newTextInKnownLanguage, It.IsAny<CancellationToken>()), Times.Once);
		...
		public async Task SaveChangesCommand_ForNewTranslationMode_ClearsDataAfterSaving()
		{
			...
			dependencies.EditVocabularyServiceMock.Setup(x => x.AddTranslation(It.IsAny<LanguageText>(), It.IsAny<LanguageText>(), It.IsAny<CancellationToken>())).ReturnsAsync(newTranslation);
			...
			dependencies.CreateOrPickTextInStudiedLanguageViewModelMock.Invocations.Clear();
			dependencies.CreateOrPickTextInKnownLanguageViewModelMock.Invocations.Clear();
			dependencies.EditVocabularyServiceMock.Invocations.Clear();
			...
			dependencies.EditVocabularyServiceMock.Verify(x => x.GetTranslations(It.IsAny<Language>(), It.IsAny<Language>(), It.IsAny<CancellationToken>()), Times.Never);
		...
		public async Task SaveChangesCommand_ForEditTextInStudiedLanguageModeWithNoValidationErrors_ReloadsDataAfterSaving()
		{
			...
			dependencies.EditVocabularyServiceMock.Setup(x => x.GetTranslations(TestStudiedLanguage, TestKnownLanguage, It.IsAny<CancellationToken>())).ReturnsAsync(TestNewTranslations);
		...
		public async Task DeleteTranslation_DeletesTranslationCorrectly()
		{
			...
			dependencies.EditVocabularyServiceMock.Verify(x => x.DeleteTranslation(testTranslationViewModel.Translation, It.IsAny<CancellationToken>()), Times.Once);
		...
		public async Task DeleteTextInStudiedLanguage_DeletesTextCorrectly()
		{
			...
			dependencies.EditVocabularyServiceMock.Verify(x => x.DeleteLanguageText(testTranslationViewModel.LanguageText1.LanguageText, It.IsAny<CancellationToken>()), Times.Once);
			dependencies.EditVocabularyServiceMock.Verify(x => x.DeleteLanguageText(testTranslationViewModel.LanguageText2.LanguageText, It.IsAny<CancellationToken>()), Times.Never);
		...
		public async Task DeleteTextInKnownLanguage_DeletesTextCorrectly()
		{
			...
			dependencies.EditVocabularyServiceMock.Verify(x => x.DeleteLanguageText(testTranslationViewModel.LanguageText1.LanguageText, It.IsAny<CancellationToken>()), Times.Never);
			dependencies.EditVocabularyServiceMock.Verify(x => x.DeleteLanguageText(testTranslationViewModel.LanguageText2.LanguageText, It.IsAny<CancellationToken>()), Times.Once);
		...
		private static Task SwitchToEditTextInStudiedLanguageMode(EditVocabularyViewModel target, TranslationViewModel translation)
		{
			return ExecuteContextMenuCommand(target, translation, $"Edit Text '{translation.LanguageText1.TextWithNote}'");
		}

		private static Task SwitchToEditTextInKnownLanguageMode(EditVocabularyViewModel target, TranslationViewModel translation)
		{
			return ExecuteContextMenuCommand(target, translation, $"Edit Text '{translation.LanguageText2.TextWithNote}'");
		}

		private static async Task ExecuteContextMenuCommand(EditVocabularyViewModel target, TranslationViewModel translation, string contextMenuItemHeader)
		{
		...
		private void VerifyDataReloading(EditVocabularyViewModel target, TestTargetDependencies dependencies, IReadOnlyList<TranslationViewModel> expectedTranslationViewModels)
		{
			var expectedViewModelData = new EditVocabularyViewModelData
			{
				CurrentTextInStudiedLanguageViewModel = dependencies.CreateOrPickTextInStudiedLanguageViewModel,
